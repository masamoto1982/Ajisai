...
pub fn get_builtin_definitions() -> Vec<(&'static str, &'static str, &'static str)> {
    vec![
        ...
        // 暗号論的乱数生成
        ("CSPRNG", "暗号論的疑似乱数を生成｜[ 6 ] [ 1 ] CSPRNG → [ 3/6 ]（サイコロ）、[ 5 ] CSPRNG → 5個生成", "Random"),
    ]
}
...
# サイコロ（0/6〜5/6）
[ 6 ] [ 1 ] CSPRNG
# → [ 3/6 ]  (0/6, 1/6, 2/6, 3/6, 4/6, 5/6 のいずれか)
...
# パーセント精度で5個
[ 100 ] [ 5 ] CSPRNG
# → [ 23/100 45/100 67/100 12/100 89/100 ]
