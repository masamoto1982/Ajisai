...
pub const GENERATED_WORDS: &[GeneratedWord] = &[
    ...
    GeneratedWord {
        ...
        standard_kind: None,
        effects: &[],
        error_when: &["nonVector", "invalidInteger"],
    ...
    GeneratedWord {
        ...
        standard_kind: None,
        effects: &[],
        error_when: &["invalidInteger", "stackUnderflow"],
    ...
    GeneratedWord {
        ...
        standard_kind: None,
        effects: &[],
        error_when: &["invalidInteger", "shapeMismatch"],
    ...
    GeneratedWord {
        ...
        standard_kind: Some("operational"),
        effects: &[],
        error_when: &["nonVector", "shapeMismatch"],
    ...
    GeneratedWord {
        ...
        standard_kind: None,
        effects: &[],
        error_when: &["nonVector", "shapeMismatch", "duplicateKey"],
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(2),
        stack_outputs: Arity::Fixed(1),
        operand_roles: &[OperandRole::Data, OperandRole::Control],
        nil_policy: NilPolicy::Passthrough,
        projection: &[],
        projection_reasons: &[],
        partiality: Partiality::Partial,
    ...
    GeneratedWord {
        ...
        standard_kind: Some("operational"),
        effects: &[],
        error_when: &["nonNumeric", "invalidInteger", "shapeMismatch"],
    ...
    GeneratedWord {
        ...
        operand_roles: &[OperandRole::Control],
        nil_policy: NilPolicy::RejectNil,
        projection: &[],
        projection_reasons: &[],
        partiality: Partiality::Partial,
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(2),
        stack_outputs: Arity::Fixed(0),
        operand_roles: &[OperandRole::Element, OperandRole::Control],
        nil_policy: NilPolicy::ConsumeNil,
        projection: &[],
        projection_reasons: &[],
        partiality: Partiality::Partial,
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(2),
        stack_outputs: Arity::Fixed(0),
        operand_roles: &[OperandRole::Control, OperandRole::Control],
        nil_policy: NilPolicy::RejectNil,
        projection: &[],
        projection_reasons: &[],
        partiality: Partiality::Partial,
