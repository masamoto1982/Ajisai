...
pub const GENERATED_WORDS: &[GeneratedWord] = &[
    ...
    GeneratedWord {
        ...
        projection: &["budgetExhausted"],
        projection_reasons: &["undecidable"],
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["integerProjectionUndecidable", "divisorEqualsZero"],
        projection_reasons: &["undecidable", "divisionByZero"],
        partiality: Partiality::Projecting,
        accepted_domain: None,
        purity: Purity::Pure,
        determinism: Determinism::Deterministic,
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["integerProjectionUndecidable"],
        projection_reasons: &["undecidable"],
        partiality: Partiality::Projecting,
        accepted_domain: None,
        purity: Purity::Pure,
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["denominatorIsNotAPositiveInteger"],
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["nonIntegerOperand", "tier2Operand"],
        projection_reasons: &["domainMiss", "undecidable"],
        partiality: Partiality::Projecting,
        accepted_domain: Some(AcceptedDomain::Numeric),
        purity: Purity::Pure,
        determinism: Determinism::Deterministic,
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["irrationalOperand", "tier2Operand"],
        projection_reasons: &["domainMiss", "undecidable"],
        partiality: Partiality::Projecting,
        accepted_domain: Some(AcceptedDomain::Numeric),
        purity: Purity::Pure,
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["argumentTooLargeToMaterialize"],
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["nonPositiveArgument", "tier2SignUndecidable"],
        projection_reasons: &["domainMiss", "undecidable"],
        partiality: Partiality::Projecting,
        accepted_domain: Some(AcceptedDomain::Numeric),
        purity: Purity::Pure,
    ...
    GeneratedWord {
        ...
        effects: &[],
        error_when: &["nonNumeric"],
        syntax: Some("1 ATAN 4 MUL 6 FORMAT"),
    },
    GeneratedWord {
        id: WordId::Pi,
        name: "PI",
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::RejectNil,
        projection: &["keyAbsent", "budgetExhausted"],
        projection_reasons: &["missingField", "undecidable"],
        partiality: Partiality::Projecting,
        accepted_domain: Some(AcceptedDomain::FlatNumericVector),
        purity: Purity::Pure,
        determinism: Determinism::Deterministic,
    ...
    GeneratedWord {
        ...
        syntax: Some("[ [ 1 2 ] [ 3 4 ] ] 2 [ 10 MUL ] RANK"),
    },
    GeneratedWord {
        id: WordId::Chars,
        name: "CHARS",
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::RejectNil,
        projection: &["lastDigitUndecidable"],
        projection_reasons: &["undecidable"],
        partiality: Partiality::Projecting,
    ...
    GeneratedWord {
        ...
        consumption: Consumption::Eat,
        nil_policy: NilPolicy::ConsumeNil,
        projection: &["operandCarriesAComputableReal"],
        projection_reasons: &["undecidable"],
        partiality: Partiality::Projecting,
        accepted_domain: None,
        purity: Purity::Pure,
