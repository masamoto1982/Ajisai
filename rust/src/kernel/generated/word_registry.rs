...
pub const GENERATED_WORDS: &[GeneratedWord] = &[
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(2),
        stack_outputs: Arity::Fixed(1),
        operand_roles: &[OperandRole::Leaf, OperandRole::Leaf],
        lifts_natively: true,
        nil_policy: NilPolicy::Passthrough,
        projection: &[],
        projection_reasons: &[],
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(2),
        stack_outputs: Arity::Fixed(1),
        operand_roles: &[OperandRole::Data, OperandRole::Leaf],
        lifts_natively: false,
        nil_policy: NilPolicy::PassthroughThenProject,
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(3),
        stack_outputs: Arity::Fixed(1),
        operand_roles: &[OperandRole::Data, OperandRole::Leaf, OperandRole::Element],
        lifts_natively: false,
        nil_policy: NilPolicy::PassthroughThenProject,
        projection: &["indexOutOfBounds"],
        projection_reasons: &["indexOutOfBounds"],
    ...
    GeneratedWord {
        ...
        standard_kind: Some("algorithm"),
        effects: &[],
        error_when: &["nonVector", "unsortedInput", "nonNumeric"],
    ...
    GeneratedWord {
        ...
        standard_kind: Some("algorithm"),
        effects: &[],
        error_when: &["nonText", "shapeMismatch"],
    ...
    GeneratedWord {
        ...
        stack_inputs: Arity::Fixed(3),
        stack_outputs: Arity::Fixed(1),
        operand_roles: &[OperandRole::Leaf, OperandRole::Leaf, OperandRole::Leaf],
        lifts_natively: false,
        nil_policy: NilPolicy::Passthrough,
        projection: &[],
        projection_reasons: &[],
    ...
    GeneratedWord {
        ...
        standard_kind: Some("operational"),
        effects: &[],
        error_when: &["nonNumeric", "invalidCount", "shapeMismatch"],
