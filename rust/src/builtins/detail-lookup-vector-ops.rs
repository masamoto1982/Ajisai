// rust/src/builtins/detail-lookup-vector-ops.rs
//
// Detailed documentation for vector operation words
// (position ops, quantity ops, vector structure, sort)

/// Returns detailed documentation for vector operation words.
