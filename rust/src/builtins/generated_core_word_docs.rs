...
pub(crate) const GENERATED_CORE_WORD_DOCS: &[GeneratedCoreWordDoc] = &[
    ...
    GeneratedCoreWordDoc {
        name: "PROBE",
        category: "control",
        summary: "Infer a code block's contract against the current dictionary, without evaluating it, and answer it as a Record.",
        role: "Control primitive: narrow a description into what can be known about it without running it.",
        stack_effect: "[ code ] -> [ record ]",
