// rust/src/builtins/detail-lookup-arithmetic-logic.rs
//
// Detailed documentation for arithmetic, comparison, and logic words

/// Returns detailed documentation for arithmetic, comparison, and logic words.
