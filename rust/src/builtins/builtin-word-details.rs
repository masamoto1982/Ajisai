...
- MUSIC::PLAYの後、モードはSEQにリセットされます"#.to_string(),
...
## 注意
- グローバル設定です（全ての再生に影響）
- MUSIC::GAIN-RESET でデフォルトに戻せます"#.to_string(),
...
MUSIC::GAIN-RESET
[ 440 ] MUSIC::PLAY           # 100%で再生"#.to_string(),
...
- グローバル設定です（全ての再生に影響）
- ヘッドフォンで効果が明確になります
- MUSIC::PAN-RESET でデフォルトに戻せます"#.to_string(),
...
[ 440 ] MUSIC::PLAY           # 左から再生
MUSIC::PAN-RESET
[ 440 ] MUSIC::PLAY           # 中央から再生"#.to_string(),
