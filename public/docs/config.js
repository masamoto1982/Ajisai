 ...
 * ============================================================================
 * テーマカラーは ../ajisai-theme.js から読み込まれます。
 * カラーを変更する場合は ajisai-theme.js を編集してください。
 */
...
const SiteConfig = {
    ...
    // 1. デザインテーマ設定
    // -------------------------------------------------------------------------
    // テーマカラーは AjisaiTheme から自動的に適用されます
    // 個別に上書きする場合のみここに記述してください
    theme: null,  // AjisaiTheme.getAll() で取得
