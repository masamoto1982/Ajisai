    ...
    private getTestCases(): TestCase[] {
        return [
            ...
            },
            {
                ...
                code: "[ [ 0 ] = : [ 0 ] : [ 0 ] > : [ 1 ] : [ -1 ] ] 'SIGN' 'Returns sign of a number' DEF\n[ 5 ] SIGN",
            ...
            {
                name: "DEF - 算術演算の定義と実行",
                code: "[ [ 1 ] [ 2 ] + ] 'ADD12' 'Adds 1 and 2' DEF\nADD12",
            ...
            },
            {
                ...
                code: "[ [ 0 ] = : [ 0 ] : [ 0 ] > : [ 1 ] : [ -1 ] ] 'SIGN' 'Sign function' DEF\n[ 5 ] SIGN",
                expectedStack: [this.createVector([this.createNumber('1')])],
                category: "Custom Word Definition"
            },
            {
            ...
            {
                name: "DEF - デフォルト節のみ",
                code: "[ : [ 999 ] ] 'ALWAYS_999' 'Always 999' DEF\n[ 123 ] ALWAYS_999",
                expectedStack: [this.createVector([this.createNumber('999')])],
                category: "Custom Word Definition"
            },
            {
                name: "DEF - ワードの再利用",
                code: "[ [ 2 ] * ] 'DOUBLE' 'Double a number' DEF\n[ 3 ]\nDOUBLE\nDOUBLE",
            ...
            {
                name: "TIMES - 1回の実行",
                code: "[ [ 5 ] [ 5 ] * ] 'SQUARE5' 'Squares 5' DEF\n'SQUARE5' [ 1 ] TIMES",
                expectedStack: [this.createVector([this.createNumber('25')])],
                category: "Control Flow - TIMES/WAIT"
            },
            {
                name: "WAIT - 基本的な遅延実行",
                code: "[ [ 100 ] ] 'HUNDRED' 'Pushes 100' DEF\n'HUNDRED' [ 10 ] WAIT",
                expectedStack: [this.createVector([this.createNumber('100')])],
                category: "Control Flow - TIMES/WAIT"
            },
            {
            ...
            {
                name: "DEL - ワードの削除",
                code: "[ [ 42 ] ] 'TEMP' 'Temporary word' DEF\n'TEMP' DEL",
                expectedStack: [],
            ...
            // === 高階関数 - FILTER ===
            {
                ...
                code: "[ [ 5 ] > ] 'IS-BIG' 'Greater than 5' DEF\n[ 3 7 2 8 1 9 ] 'IS-BIG' FILTER",
                expectedStack: [this.createVector([
                    this.createNumber('7'),
                    this.createNumber('8'),
                    this.createNumber('9')
            ...
            {
                name: "FILTER - すべて真",
                code: "[ [ 0 ] > ] 'IS-POSITIVE' 'Greater than 0' DEF\n[ 1 2 3 4 5 ] 'IS-POSITIVE' FILTER",
                expectedStack: [this.createVector([
                    this.createNumber('1'),
                    this.createNumber('2'),
                    this.createNumber('3'),
            ...
            {
                name: "FILTER - すべて偽",
                code: "[ [ 10 ] > ] 'IS-BIG' 'Greater than 10' DEF\n[ 1 2 3 ] 'IS-BIG' FILTER",
                expectedStack: [this.createVector([])],
                category: "Higher-Order Functions"
            },
            {
