// masamoto1982/ajisai/Ajisai-ee4bfff782abb9ac9f67398eb67f7534d77483b5/js/main.js

// './gui/main.js' からエクスポートされた GUI_INSTANCE (GUIクラスのインスタンス) をインポートします。
import { GUI_INSTANCE } from './gui/main.js';
// './wasm-loader.js' から wasm を初期化する関数をインポートします。
