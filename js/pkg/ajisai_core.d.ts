...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hdc3865da1965ef6a: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h1e107cdaeab3818b: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h0aafc99f4757d36f: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h3055d5a57fef93a5: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hc6b279a8ab4ea988: (a: number, b: number, c: any, d: any) => void;
