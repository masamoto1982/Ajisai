...
// execution). Without this cache the whole set was rebuilt on every keystroke.
...
export const createGUI = (): GUI => {
    ...
    const updateAllDisplays = (_executedCode?: string): void => {
    ...
    const init = async (): Promise<void> => {
        ...
        dictionarySheetSelector.setEntries([
            { sheetId: 'core', label: 'Core Words' },
            { sheetId: 'user', label: 'User Words' },
        ]);
