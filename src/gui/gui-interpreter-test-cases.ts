...
//   - Comparison words (EQ / NE / LT / LE) and their sugar (=, <>, <, <=),
...
export const TEST_CASES: TestCase[] = [
    ...
    {
        name: 'LE on equal values pushes 1',
        code: '3 3 <=',
        expectedStack: [createNumber('1')],
        category: 'Comparison',
    },
    {
        name: 'Greater-than is written by swapping: 5 < 3 ? = false',
        code: '5 3 <',
    ...
    {
        name: 'GT word is not provided',
        code: '1 2 GT',
        expectError: true,
        category: 'Comparison',
    },
    {
        name: '>= sugar is not provided',
        code: '1 2 >=',
        expectError: true,
        category: 'Comparison',
    },
