...
export class AjisaiInterpreter {
    ...
    /**
     * @param {string} _module_name
     * @returns {any}
     */
    collect_module_sample_words_info(_module_name) {
        const ptr0 = passStringToWasm0(_module_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
     ...
     * @returns {any}
     */
    collect_module_words_info(_module_name) {
        const ptr0 = passStringToWasm0(_module_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
     ...
     * @param {any} _modules
     */
    restore_imported_modules(_modules) {
        wasm.ajisaiinterpreter_restore_imported_modules(this.__wbg_ptr, _modules);
    }
    /**
     * @param {any} _stack_js
     */
    restore_stack(_stack_js) {
        wasm.ajisaiinterpreter_restore_stack(this.__wbg_ptr, _stack_js);
    }
    /**
     * @param {any} words
     */
    restore_user_words(words) {
        wasm.ajisaiinterpreter_restore_user_words(this.__wbg_ptr, words);
    }
    /**
     * @param {string} _mode
     */
