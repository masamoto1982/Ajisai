...
export const ajisaiinterpreter_collect_available_modules: (a: number) => any;
...
export const ajisaiinterpreter_collect_import_state: (a: number) => any;
...
export const ajisaiinterpreter_collect_transitive_dependents: (a: number, b: number, c: number) => any;
...
export const ajisaiinterpreter_define_word_forced: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
...
export const ajisaiinterpreter_restore_import_state: (a: number, b: any) => void;
...
export const wasm_bindgen__convert__closures_____invoke__h36e5ee22798341e6: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h48bc09329ed267e3: (a: number, b: number, c: any, d: any) => void;
