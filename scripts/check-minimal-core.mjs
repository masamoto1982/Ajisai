...
CHARS JOIN NUM STR
COND EXEC NIL NIL? NIL-REASON VENT KEEP BIND DEF DEL LOOKUP PRINT REFLECT RANDOM`.split(/\s+/));
...
TAKE REVERSE INDEX-OF TRIM TOKENIZE SUBSTITUTE SUM`.split(/\s+/));
...
console.log('[minimal-core] 37/37 Semantic Kernel Words have executable witnesses.');
console.log('[minimal-core] 30/30 Standard Words have complete contracts and law witnesses.');
console.log(
