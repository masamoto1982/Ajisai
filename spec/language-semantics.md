...
<div class="ref-table-wrap"><table class="ref-table"><thead><tr><th>Count</th><th>What</th></tr></thead><tbody><tr><td>65</td><td>Canonical Words — the vocabulary (<code>docs/word-manifest.json</code> is the count of record)</td></tr><tr><td>12</td><td>Symbolic aliases — surface forms of those Words, not counted as vocabulary</td></tr><tr><td>36</td><td>Semantic Kernel Words, within the 65 — carry the language's semantic identity</td></tr><tr><td>29</td><td>Standard Words, within the 65 — carry its practical surface</td></tr></tbody></table></div>
