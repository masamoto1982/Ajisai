...
- **None**: TRUE, FALSE, NIL, NOW, CSPRNG, DATETIME, TIMESTAMP, DEF, DEL, `?`, ROUTE, WAIT, `:` `;` `=>` `==` `.` `..` `,` `,,` `~` `!` COLLECT, EXEC, EVAL, HASH, FRAME, IMPORT
...
| `interpreter/control.rs` | ROUTE (branching/looping), EXEC, EVAL |
