...
更新: 2026-08-14 — 上記の実施内容に対する第三者レビューが較正ホストの
誤り（native で較正して WASM に適用していた）と `Fraction::hash` の gcd
欠陥を発見し、修正・再導出した。実施記録は同文書の §10。
§6 / §9 / §10.5 の未測定事項はほぼそのまま残っているので、次に着手する前に
`host-profile-derivation-2026-08-14.md` の §9・§10.5 を読むこと。
