...
Implementation status: **Phase 4 in progress** — V1 schema、golden、contract test、Kernel adapterを削除し、HostProtocolV2を唯一のcurrent protocolとした。Phase 3のcollection/text witnessと、旧persistence/import・execution-mode互換の除去は引き続きβ gateまでに完了する。
