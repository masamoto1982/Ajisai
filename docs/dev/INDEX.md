...
| `data-module-phase8c-design.md` | Phase 8C DATA モジュールメモ（unit 1: `CSV-PARSE`/`CSV-STRINGIFY`、unit 2: `SELECT`/`WHERE`、unit 3: `GROUP`、unit 4: `JOIN`。純粋変換 / Core 構文・reason 非追加 / 欠損 = `MissingField`） | `[実装済み]` |
