...
export const TOOLS = [
  {
    ...
    description:
      ...
      "Its 86 Words cover arithmetic (ADD SUB MUL DIV MOD FLOOR CEIL ROUND ABS NEG MIN MAX SQRT), comparison (EQ NEQ LT LTE GT GTE), boolean logic (AND OR NOT), " +
...
const RESOURCES = [
  ...
  // caller cannot do that from 86 separate probes.
