...
データプレーンは、流れる水そのものだ。  
数、Vector、コードブロック、NIL——値はすべてここを巡る。  
算術も比較も構造操作も、すべてこの水の中で完結する。  
見た目の装飾はここには含まれない。水は水として、純粋に値を運ぶ。

→ 技術的な詳細: [SPECIFICATION.md §5.2](SPECIFICATION.md#52-two-plane-architecture)

### 波紋としてのセマンティックプレーン

水面に立つ波紋は、水ではない。  
しかし確かに水の上に現れ、水の姿を観る者に伝える。  
